...
# hexo相关依赖
cnpm install hexo-deployer-git hexo-server hexo-util moment-timezone --save
...
├── @babel/helper-validator-identifier@7.28.5 extraneous -> .\node_modules\.store\@babel+helper-validator-identifier@7.28.5\node_modules\@babel\helper-validator-identifier
├── @babel/parser@7.29.0 extraneous -> .\node_modules\.store\@babel+parser@7.29.0\node_modules\@babel\parser
├── @babel/types@7.29.0 extraneous -> .\node_modules\.store\@babel+types@7.29.0\node_modules\@babel\types
├── @renbaoshuo/markdown-it-katex@2.0.2 -> .\node_modules\.store\@renbaoshuo+markdown-it-katex@2.0.2\node_modules\@renbaoshuo\markdown-it-katex
├── babel-walk@3.0.0-canary-5 extraneous -> .\node_modules\.store\babel-walk@3.0.0-canary-5\node_modules\babel-walk
├── hexo-deployer-git@4.0.0 -> .\node_modules\.store\hexo-deployer-git@4.0.0\node_modules\hexo-deployer-git
├── hexo-generator-archive@2.0.0 -> .\node_modules\.store\hexo-generator-archive@2.0.0\node_modules\hexo-generator-archive
├── hexo-generator-category@2.0.0 -> .\node_modules\.store\hexo-generator-category@2.0.0\node_modules\hexo-generator-category
├── hexo-generator-index@4.0.0 -> .\node_modules\.store\hexo-generator-index@4.0.0\node_modules\hexo-generator-index
├── hexo-generator-tag@2.0.0 -> .\node_modules\.store\hexo-generator-tag@2.0.0\node_modules\hexo-generator-tag
├── hexo-renderer-ejs@2.0.0 -> .\node_modules\.store\hexo-renderer-ejs@2.0.0\node_modules\hexo-renderer-ejs
├── hexo-renderer-markdown-it@7.1.1 -> .\node_modules\.store\hexo-renderer-markdown-it@7.1.1\node_modules\hexo-renderer-markdown-it
├── hexo-renderer-pug@3.0.0 -> .\node_modules\.store\hexo-renderer-pug@3.0.0\node_modules\hexo-renderer-pug
├── hexo-renderer-stylus@3.0.1 -> .\node_modules\.store\hexo-renderer-stylus@3.0.1\node_modules\hexo-renderer-stylus
├── hexo-server@3.0.0 -> .\node_modules\.store\hexo-server@3.0.0\node_modules\hexo-server
├── hexo-util@4.0.0 -> .\node_modules\.store\hexo-util@4.0.0\node_modules\hexo-util
├── hexo@8.1.1 -> .\node_modules\.store\hexo@8.1.1\node_modules\hexo
├── katex@0.16.28 -> .\node_modules\.store\katex@0.16.28\node_modules\katex
└── moment-timezone@0.6.0 -> .\node_modules\.store\moment-timezone@0.6.0\node_modules\moment-timezone
```
...
- 创建页面(tags categories)
```bash
hexo new page tags
hexo new page categories
```
创建后可以在文章yaml中配置文章的tags和categories